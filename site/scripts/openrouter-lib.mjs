/**
 * Shared OpenRouter client for East Village Door Supplier site generation.
 */
...
const SITE = "https://eastvillagedoorsupplieranddoorrepair.com";
const APP_TITLE = "East Village Door Supplier and Door Repair";
