/**
 * Finalize East Village Door door brand assets from OpenRouter-generated logo master.
 */
import {
  copyFileSync,
  existsSync,
...
await sharp(logoPath)
  .resize(256, 256, { fit: "contain", background: { r: 248, g: 246, b: 243, alpha: 1 } })
  .png({ compressionLevel: 9 })
  .toFile(at("app/icon.png"));

await sharp(logoPath)
  .resize(180, 180, { fit: "contain", background: { r: 248, g: 246, b: 243, alpha: 1 } })
  .png({ compressionLevel: 9 })
  .toFile(at("app/apple-icon.png"));

await sharp(logoPath)
  .resize(32, 32, { fit: "contain", background: { r: 13, g: 110, b: 110, alpha: 1 } })
  .png({ compressionLevel: 9 })
...
console.log("East Village Door door asset finalization complete");
