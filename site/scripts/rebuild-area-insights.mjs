  ...
  areas.map((area) => {
    ...
    return [
      area.slug,
      {
        ...
        neighborhood_notes: `${city} is within East Village Door Supplier and Door Repair's regular NYC service area from our East Village headquarters at 99 Loisaida Ave. ${propertyNotes[index]}`,
        keywords: [
