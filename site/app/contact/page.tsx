...
export const metadata: Metadata = {
  ...
  description:
    `Contact ${BIZ.name} to discuss a door project, text photos, or request a free quote across Manhattan & Brooklyn.`,
...
export default function ContactPage() {
  return (
    <>
      <section className="relative overflow-hidden border-b border-cream-300 bg-aurora py-20">
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center md:px-6">
          ...
          <h1 className="mt-5 font-display text-4xl font-extrabold tracking-tight md:text-6xl">
            Plan your <span className="text-accent-gradient">door project</span>.
          </h1>
          <p className="mt-4 text-cream-700">
            Call, email, text project photos, or send a quote request for a Manhattan or Brooklyn property.
          </p>
      ...
      <section className="py-16">
        <div className="mx-auto grid max-w-7xl gap-8 px-4 md:grid-cols-3 md:px-6">
          <div className="rounded-3xl border border-teal-500/30 bg-teal-500/5 p-6">
          ...
          <div className="rounded-3xl border border-emerald-500/30 bg-emerald-500/5 p-6">
            ...
            <p className="mt-3 text-sm text-cream-700">
              ...
              <a href="/hours" className="text-teal-600 underline-offset-2 hover:underline">hours page</a>{" "}
              for the complete schedule.
            </p>
          </div>
          <div className="rounded-3xl border border-cream-300 bg-cream-50/50 p-6">
            <div className="flex items-center gap-2 text-cream-800">
              <MapPin className="h-5 w-5 text-teal-600" />
              <span className="text-sm font-semibold uppercase tracking-wider">Service area</span>
            </div>
            <p className="mt-3 text-sm text-cream-700">
              Manhattan &amp; Brooklyn — including neighborhoods throughout the NYC tri-borough area.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-cream-300 py-16">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="mb-6">
            <p className="text-sm font-semibold uppercase tracking-wider text-teal-600">Shop location</p>
      ...
      <section className="border-t border-cream-300 py-16">
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <p className="text-sm font-semibold uppercase tracking-wider text-teal-600">How to reach us</p>
          <h2 className="mt-2 font-display text-3xl font-bold tracking-tight md:text-4xl">
            Three ways to discuss a NYC door project.
          </h2>
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="rounded-sm border border-cream-300 bg-cream-50/50 p-6">
              ...
              <a href={BIZ.phoneHref} className="mt-4 inline-block font-mono text-teal-600 underline-offset-4 hover:underline">
                {BIZ.phone}
              </a>
            </div>
            <div className="rounded-sm border border-cream-300 bg-cream-50/50 p-6">
              ...
              <a href={BIZ.smsHref} className="mt-4 inline-block text-sm font-semibold text-teal-600 underline-offset-4 hover:underline">
                Text {BIZ.phone} →
              </a>
            </div>
            <div className="rounded-sm border border-cream-300 bg-cream-50/50 p-6">
              ...
              <a href="/quote" className="mt-4 inline-block text-sm font-semibold text-teal-600 underline-offset-4 hover:underline">
                Start the quote →
              </a>
            </div>
          </div>

          <div className="mt-10 rounded-sm border border-cream-300 bg-cream-50/40 p-6 text-sm text-cream-700">
            <p>
            ...
            <p className="mt-3">
              <strong className="text-white">Where we go.</strong> Manhattan and Brooklyn, and neighborhoods
              throughout the tri-borough area — see our{" "}
              <a href="/service-areas" className="text-teal-600 underline-offset-2 hover:underline">service area map</a>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-cream-300 bg-aurora py-16 text-center">
        <div className="mx-auto max-w-3xl px-4 md:px-6">
          ...
          <p className="mt-3 text-cream-700">Tell us about your door project.</p>
