...
export default function ContactPage() {
  return (
    <>
      <section className="relative overflow-hidden border-b border-stone-300 bg-aurora py-20">
        ...
        <div className="mx-auto grid max-w-7xl gap-8 px-4 md:grid-cols-3 md:px-6">
          ...
          <div className="rounded-3xl border border-emerald-500/30 bg-emerald-500/5 p-6">
            ...
            <p className="mt-3 text-sm text-stone-700">
              ...
              <a href="/hours" className="text-indigo-600 underline-offset-2 hover:underline">hours page</a>{" "}
              for the complete schedule.
            </p>
          </div>
          <div className="rounded-3xl border border-stone-300 bg-stone-50/50 p-6">
      ...
      <section className="border-t border-stone-300 py-16">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <div className="mb-6">
            <p className="text-sm font-semibold uppercase tracking-wider text-indigo-600">Shop location</p>
      ...
      <section className="border-t border-stone-300 py-16">
        <div className="mx-auto max-w-4xl px-4 md:px-6">
          <p className="text-sm font-semibold uppercase tracking-wider text-indigo-600">How to reach us</p>
          <h2 className="mt-2 font-display text-3xl font-bold tracking-tight md:text-4xl">
            Three ways to discuss a NYC door project.
          </h2>
          <div className="mt-8 grid gap-6 md:grid-cols-3">
            <div className="rounded-sm border border-stone-300 bg-stone-50/50 p-6">
              ...
              <a href={BIZ.phoneHref} className="mt-4 inline-block font-mono text-indigo-600 underline-offset-4 hover:underline">
                {BIZ.phone}
              </a>
            </div>
            <div className="rounded-sm border border-stone-300 bg-stone-50/50 p-6">
              ...
              <a href={BIZ.smsHref} className="mt-4 inline-block text-sm font-semibold text-indigo-600 underline-offset-4 hover:underline">
                Text {BIZ.phone} →
              </a>
            </div>
            <div className="rounded-sm border border-stone-300 bg-stone-50/50 p-6">
              ...
              <a href="/quote" className="mt-4 inline-block text-sm font-semibold text-indigo-600 underline-offset-4 hover:underline">
                Start the quote →
              </a>
            </div>
          </div>

          <div className="mt-10 rounded-sm border border-stone-300 bg-stone-50/40 p-6 text-sm text-stone-700">
            <p>
            ...
            <p className="mt-3">
              ...
              <a href="/service-areas" className="text-indigo-600 underline-offset-2 hover:underline">service area map</a>.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-stone-300 bg-aurora py-16 text-center">
        <div className="mx-auto max-w-3xl px-4 md:px-6">
          ...
          <p className="mt-3 text-stone-700">Tell us about your door project.</p>
