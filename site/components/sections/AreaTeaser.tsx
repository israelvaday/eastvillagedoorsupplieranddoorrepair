    ...
    <section className="relative py-20">
      <div className="mx-auto max-w-7xl px-4 md:px-6">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          {MAIN_AREAS.map((a) => (
            <Link
              ...
              className="group flex items-center justify-between gap-3 rounded-sm border border-stone-300 bg-stone-50/50 p-4 transition-all hover:-translate-y-0.5 hover:border-indigo-500/50"
            >
              <div className="flex items-center gap-3">
                <span className="grid h-9 w-9 place-items-center rounded-lg bg-indigo-500/10 text-indigo-600">
        ...
        <div className="mt-8">
          <Link
            href="/service-areas"
            className="inline-flex items-center gap-2 rounded-full border border-indigo-500/40 bg-indigo-500/10 px-5 py-2.5 text-sm font-semibold text-indigo-600 transition-all hover:bg-indigo-500/20"
          >
