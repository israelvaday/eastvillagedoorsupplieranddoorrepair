...
export const SERVICES: Service[] = [
  {
    ...
    icon: Home,
    tagline: "Precision-fit entry, interior, and specialty doors for East Village and NYC homes.",
    description:
      "From pre-war walk-ups to modern condos, East Village Door Supplier installs solid-core, hollow-core, fire-rated, and custom residential doors with accurate framing, hardware alignment, and weather sealing. We measure on-site from our Loisaida Ave headquarters, source premium door slabs and frames, and complete every installation with level swings, clean reveals, and durable hardware mounting.",
    bullets: [
    ...
    intent: "service",
    keywords: [
      "residential door installation east village",
      "door installer nyc",
      "interior door replacement manhattan ny",
      "entry door installation lower east side",
      "home door contractor east village",
    ],
  },
  {
  ...
  },
  {
    ...
    description:
      "Non-standard openings, historic profiles, and design-driven projects need more than off-the-shelf slabs. East Village Door Supplier fabricates and installs custom wood, metal-clad, and specialty doors sized to your jamb, with matching casings, transoms, and hardware prep for Brooklyn townhouses, loft conversions, and high-end renovations across NYC.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Multifamily, commercial, and mixed-use buildings across NYC require properly labeled fire-rated door assemblies. East Village Door Supplier supplies and installs fire-rated doors and frames with correct labels, self-closing hardware, and smoke-seal components — coordinated with your superintendent, architect, or expeditor for DOB and FDNY compliance.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Retail storefronts, restaurant entrances, and ground-floor commercial spaces need durable aluminum and glass door systems that handle daily traffic and NYC weather. East Village Door Supplier installs and repairs storefront doors, entrance pairs, panic hardware, floor closers, and weather seals for businesses across Manhattan and Brooklyn.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "Rot, impact damage, termite trails, and repeated settling take a toll on door frames in NYC buildings. East Village Door Supplier repairs and replaces door jambs, headers, casings, and subsills using materials matched to your wall construction — brick, plaster, drywall, or metal stud — so new or existing doors hang square and latch reliably.",
    bullets: [
  ...
  },
  {
    ...
    description:
      "From reinforced entry systems to access-control-ready doors for commercial suites and multifamily lobbies, East Village Door Supplier installs security-focused door assemblies with heavy-duty hardware, reinforced strikes, multi-point locks, and prep for intercoms, keypads, and electric release systems throughout NYC.",
    bullets: [
