...
export const FAQ_SECTIONS: FAQSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. East Village Door Supplier and Door Repair provides free estimates for residential and commercial door work across Manhattan and Brooklyn. Photos help for initial review; most projects require an on-site measurement before final pricing.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "East Village Door Supplier and Door Repair provides insured professional door technicians and direct project communication from our East Village headquarters at 99 Loisaida Ave.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        q: "Do you work in pre-war East Village and Manhattan walk-ups?",
      ...
      },
      {
        ...
        a: "Yes. We respond to break-in damage, failed locks, bent frames, and storefront failures across Manhattan and Brooklyn. We stabilize the opening and restore security hardware, with permanent repairs scheduled when needed.",
      },
      {
        q: "What areas do you serve from your East Village location?",
        a: "East Village Door Supplier and Door Repair serves 100 neighborhoods across Manhattan and Brooklyn from our headquarters at 99 Loisaida Ave, New York, NY 10009. See our service areas page for the full coverage map.",
      },
    ],
  },
];
